...
:	Analyzer2(),  
	mSettings( new SyncSerialAnalyzerSettings() ),
...
{
	mResults.reset( new SyncSerialAnalyzerResults( this, mSettings.get() ) );
	SetAnalyzerResults( mResults.get() );
	mResults->AddChannelBubblesWillAppearOn( mSettings->mInputChannel );
}

void SyncSerialAnalyzer::WorkerThread()
{
...
U32 SyncSerialAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate, SimulationChannelDescriptor** simulation_channels )
{
